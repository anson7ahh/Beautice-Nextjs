            ...
            <div className="container relative z-10">
                <div className="relative flex ipadMini:flex-row flex-col w-full ml-5 ipadMini:ml-0 items-center justify-center gap-y-10 px-5 ipadMini:px-0">
                    <div className="mx-auto ipadMini:ml-0 ipadMini:text-left text-center">
                        <p className="text-vividpink text-base leading-5 font-semibold mb-4  ipadMini:text-left">About Us</p>
                        ...
                        <p className="max-w-[483px] leading-6 tracking-[1.6px] text-base text-darkgray mb-[25px] ">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elit, quam
                            suscipit purus donec amet. Egestas volutpat facilisi eu libero. Nunc, ipsum ornare mauris sit quam quis enim. Varius tellus in suspendisse placerat.
                        </p>
                        ...
                        <div className="flex mt-[50px] justify-center">
                            <Button type="button" className="bg-vividpink text-white w-[150px] ipadMini:w-[200px] rounded-[50px] text-center tracking-[1.6px] 
                            text-[16px] ipadMini:leading-[58.36px] leading-[38.36px] font-semibold">Learn More</Button>
